...
For using it, see [run models locally](/moose-inference/local/).
...
The untiered Gemma entries backed the three tiers until [ADR 01009](https://github.com/hawkeyexl/moose-inference/blob/main/adrs/01009-retier-the-local-model-catalog-by-measurement.md)
retiered the catalog on measured results. They still resolve by name, so an existing pin keeps
working; nothing selects them automatically.
...
no GPU. See [testing your integration](/moose-inference/keep-it-working/testing/).
