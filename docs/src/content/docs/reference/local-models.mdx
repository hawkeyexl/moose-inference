...
The untiered Gemma entries backed the three tiers until [ADR 01009](https://github.com/hawkeyexl/ts-inference/blob/main/adrs/01009-retier-the-local-model-catalog-by-measurement.md)
